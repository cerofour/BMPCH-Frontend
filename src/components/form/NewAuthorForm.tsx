	...
	const mutation = useMutation({
		...
		onSuccess: () => {
			...
			context?.setToastData(
				isEditMode ? "El autor se ha actualizado exitosamente." 
				: "El autor se ha creado exitosamente.",
				"success");
			setShow(false);
		},
		...
		onError: () => {
			context?.toggleToast();
			context?.setToastData(
				isEditMode ? "No se ha podido actualizar el autor." 
				: "No se ha podido crear el autor.",
      			"danger"
			);
		},
	});
