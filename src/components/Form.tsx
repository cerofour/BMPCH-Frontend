...
import { TextDTO, AuthorAPIObject, TextTypeAPIObject, EditorialAPIObject } from "../api/types";
import { getAllTypes, getAllEditorials, getAllAuthors, newText, newUser } from "../api/api";
			...
			<Container fluid>
				<Form>
					...
					<Form.Group className="mb-3" controlId="formTitulo">
						...
						<Form.Control onChange={(e) => setName(e.target.value)} type="text"></Form.Control>
					</Form.Group>
					<Form.Group className="mb-3" controlId="formTitulo">
						<Form.Label> Apellido Paterno </Form.Label>
						<Form.Control onChange={(e) => setPlastname(e.target.value)} type="text"></Form.Control>
					</Form.Group>
					<Form.Group className="mb-3" controlId="formTitulo">
						<Form.Label> Apellido Materno </Form.Label>
						<Form.Control onChange={(e) => setMlastname(e.target.value)} type="text"></Form.Control>
					</Form.Group>

					<Form.Group className="mb-3" controlId="formTitulo">
						<Form.Label> Número de Celular </Form.Label>
						<Form.Control onChange={(e) => setPhoneNumber(e.target.value)} type="text"></Form.Control>
					</Form.Group>

					<Form.Group className="mb-3" controlId="formTitulo">
						<Form.Label> Contraseña </Form.Label>
						<Form.Control onChange={(e) => setPsk(e.target.value)} type="text"></Form.Control>
					</Form.Group>
